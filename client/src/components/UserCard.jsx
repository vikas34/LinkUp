...
import { Feather, MapPin, MessageCircle, Plus, UserPlus } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex mt-4 gap-2">
        ...
        {/* Connection Request Button / Messaage Button */}
        <button
          onClick={handleConnectionRequest}
          className="w-16 flex items-center justify-center border text-slate-500 
