...
const SideBar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      className={`w-60 h-screen xl:w-72 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 
    ${
    ...
    >
      ...
      <div className="w-full border-t border-gray-200  p-4 px-7 flex items-center justify-between">
        <div className="flex gap-2 items-center cursor-pointer">
          <UserButton />
          <div>
            <h1 className="tex-sm font-medium ">{user.full_name}</h1>
